        ...
        <div id="collapseMenu" className={`max-lg:hidden lg:!block ${isMenuOpen ? 'block' : 'hidden'} max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50`}>
          ...
          <ul className='lg:flex gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
            ...
            <li className='max-lg:border-b max-lg:py-3 px-3'>
              <a href='#' className='hover:text-[#007bff] text-[#007bff] font-bold block text-base'>Home</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'>
              <a href='#' className='hover:text-[#007bff] text-gray-600 font-bold block text-base'>Team</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'>
              <a href='#' className='hover:text-[#007bff] text-gray-600 font-bold block text-base'>Feature</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'>
              <a href='#' className='hover:text-[#007bff] text-gray-600 font-bold block text-base'>Blog</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'>
              <a href='#' className='hover:text-[#007bff] text-gray-600 font-bold block text-base'>About</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'>
              <a href='#' className='hover:text-[#007bff] text-gray-600 font-bold block text-base'>Contact</a>
            </li>
          </ul>
        </div>
