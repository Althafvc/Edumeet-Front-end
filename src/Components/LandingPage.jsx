  ...
  return (
        ...
        <div className="content w-screen h-full flex flex-col gap-7">
           ...
           <div className="expansion1 w-full h-auto flex flex-col justify-center items-center gap-4 md:flex-row ">
            ...
            <div className='w-full flex justify-center'><button className='px-3 py-2 rounded font-bold text-white bg-[#7391e0] active:scale-[.96] duration-50 ease-in-out ' onClick={alertClicked}>Get Started</button> </div>
            </div>
