  ...
  return (
    <>
      <div className="container w-screen h-screen flex justify-center items-center bg-white">
        <div className="form-container px-2 md:px-0 rounded-2xl md:w-[55%] md:h-[590px] flex flex-col md:flex-row shadow-customShadow overflow-auto md:overflow-hidden h-auto">
          ...
          <div className="form-area flex flex-col bg-[#163c3a]  md:w-[50%] justify-center pl-8 py-3 gap-6">
            ...
            <div className="signupform-area w-full justify-center">
              <form className="flex pl-10 flex-col gap-2.5 w-full"  onSubmit={handleSubmit(onSubmit)}>
                ...
                <p className='pl-16 md:pl-[120px] text-gray-300'>Existing member <a href="/teacher/login" className='text-white hover:underline'>Login here</a></p>
              </form> 
            </div>
          </div>
        </div>
